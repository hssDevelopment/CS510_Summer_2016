...
/**
 * Reads a line into an appointment or parses the owner's name. Used by Text Parser to read in lines
 * from a file.
 */
public class LineReader {

    private static final Integer DESCRIPTION_POSITION = 0;
    private static final Integer BEGIN_TIME_POSITION = 1;
    private static final Integer END_TIME_POSITION = 2;
    private static final String DELIMITER = ",";

    private static final String OWNER_DELIMITER = ":";
    public static final String OWNER_MARKER = "owner";
    private static final Integer OWNER_VALUE_POSITION = 1;

    /**
     * @param line the line to read into an appointment
     * @return new Appointment when a line in the format description,beginTime,endTime. Will throw a
     * parser exception if the line is invalid.
     */
     ...
     *
     * Will attempt to read the name of the owner of a string owner:name_of_owner - if it is not in
     * that format, this method will throw a parser exception.
     */
